...
type
  TGeralDMfrm = class(TDataModule)
    ...
    updAgenda: TFDUpdateSQL;
    qryAgendaID: TIntegerField;
    qryAgendaEMISSOR: TStringField;
    qryAgendaDATA_CADASTRO: TSQLTimeStampField;
    qryAgendaCLIENTE: TStringField;
    qryAgendaDATA_ALTERACAO: TSQLTimeStampField;
    qryAgendaDOCUMENTO: TStringField;
